#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_eventQuery_moreTaskName_query_fail_101_001
# 用例标题: 完整摄像机名后多一个字符的关键字查询摄像机
# 预置条件: 
#	1.管理员账号已进入事件查询页面
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_eventQuery_moreTaskName_query_fail_101_001
	#登录系统
	...
	#在查询输入框中输入：基础视频1
	@driver.eventQuery_taskName_textField.set("基础视频1")
	#下拉框返回无
