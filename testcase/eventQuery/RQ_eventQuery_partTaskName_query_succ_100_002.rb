#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_eventQuery_partTaskName_query_succ_100_002
# 用例标题: 部分关键字查询已存在的包含摄像机名
# 预置条件: 
#	1.管理员账号已进入事件查询页面
#	2.已启用摄像机名为“基础视频”的摄像机且已产生事件
# 测试步骤:
#	1.在查询输入框输入：“基础”；点选“基础视频”
#	2.点击“查询”按钮
#	3.查看事件列表
# 预期结果:
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_eventQuery_partTaskName_query_succ_100_002
	#登录系统
	...
	#在查询输入框中输入：基础
	@driver.eventQuery_taskName_textField.set("基础 ")
	#下拉框返回摄像机名称：基础视频
