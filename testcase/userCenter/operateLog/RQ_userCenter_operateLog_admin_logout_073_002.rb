#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_userCenter_operateLog_admin_logout_073_002
# 用例标题: 过滤管理员的登录日志
# 预置条件: 
#	1.使用管理员账号产生登出动作
#	2.管理员已进入操作日志界面
...
#	2.点击“动作”下拉框，勾选“登出”动作
#	3.进行提交
#	4.查看日志列表
# 预期结果:
#	4.成功过滤，日志列表中只显示系统管理员的登出操作日志信息
# 脚本作者: kangting
# 写作日期: 20161026
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_userCenter_operateLog_admin_logout_073_002
	#初始化用户，还原系统
	#使用管理员账号登录系统
	...
	@driver.userCenter_filterOperateLog_withAction('登出')
	
	#查看操作日志信息列表中的日志是否正确
	#判断操作日志记录时间与实际操作时间的偏差
	operateLog_recordTime = @driver.operateLog_recordTime(0)
	@driver.logTime_operateTime_deviation(logoutTime,operateLog_recordTime,'logoutTime')
