#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_userCenter_operateLog_userName_sortDown_076_006
# 用例标题: 按照用户姓名降序排序
# 预置条件: 
#	1.使用管理员账号产生登入和注销动作
#	2.管理员已进入操作日志界面
...
#	2.查看日志列表信息
# 预期结果:
#	2.“用户姓名”旁向上的小三角符号高亮显示，日志列表中的日志信息按照用户姓名的降序排序
# 脚本作者: kangting
# 写作日期: 20161027
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_userCenter_operateLog_userName_sortDown_076_006
	#初始化用户，还原系统
	#使用管理员账号登录系统
	...
	#点击日志列表中的“用户姓名”
	2.times { @driver.userCenter_trace_sort('用户姓名').click }
