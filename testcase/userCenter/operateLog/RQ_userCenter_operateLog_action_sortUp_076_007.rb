#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_userCenter_operateLog_action_sortUp_076_007
# 用例标题: 按照动作升序排序
# 预置条件: 
#	1.使用管理员账号产生登入和注销动作
#	2.管理员已进入操作日志界面
...
#	2.查看日志列表信息
# 预期结果:
#	2.“动作”旁向上的小三角符号高亮显示，日志列表中的日志信息按照动作的升序排序
# 脚本作者: kangting
# 写作日期: 20161027
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_userCenter_operateLog_action_sortUp_076_007
	#初始化用户，还原系统
	#使用管理员账号登录系统
	...
	#点击日志列表中的“用户姓名”
	@driver.userCenter_trace_sort('动作').click
	...
	@driver.logTime_operateTime_deviation(logoutTime,thirdLine_operateLog_recordTime,'logoutTime')
	#断言操作日志列表中的用户名为：user
	...
	#断言操作日志列表中的动作为：登出成功
	assert_equal('登出成功',@driver.userCenter_trace_operateLogList_index(11).when_present($waitTime).text,'动作与操作日志中不一致！')
	#注销系统，确认:0;取消：1
	@driver.logout()
  end
