#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_userCenter_operateLog_withMultiAction_075_001
# 用例标题: 根据登录和登出两个动作过滤操作日志
# 预置条件: 
#	1.使用管理员账号产生登录和注销动作
#	2.管理员已进入操作日志界面
# 测试步骤:
...
#	4.查看日志列表
# 预期结果:
#	4.成功过滤，日志列表中只显示管理员用户的登入和登出操作的日志信息
# 脚本作者: kangting
# 写作日期: 20161027
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_userCenter_operateLog_withMultiAction_075_001
	#初始化用户，还原系统
	#使用管理员账号登录系统
	...
	#过滤系统登入和登出操作的日志
	@driver.userCenter_filterOperateLog_withAction('登入','登出')
