#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_userCenter_operateLog_date_sortDown_076_002
# 用例标题: 按照日期降序排序
# 预置条件: 
#	1.使用管理员账号产生登入和注销动作
#	2.管理员已进入操作日志界面
...
#	1.查看日志列表信息
# 预期结果:
#	1.“日期”旁向下的小三角符号高亮显示，日志列表中的日志信息默认按照日期的降序排序
# 脚本作者: kangting
# 写作日期: 20161027
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_userCenter_operateLog_date_sortDown_076_002
	#初始化用户，还原系统
	#使用管理员账号登录系统
	...
	#点击两次“日期”，使排序正确
	2.times {@driver.userCenter_trace_sort('日期').click}
	#判断操作日志记录时间与实际操作时间的偏差
