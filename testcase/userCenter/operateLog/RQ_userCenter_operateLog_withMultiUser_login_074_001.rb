#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_userCenter_operateLog_withMultiUser_login_074_001
# 用例标题: 根据多个用户过滤登录日志
# 预置条件: 
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_userCenter_operateLog_withMultiUser_login_074_001
	#初始化用户，还原系统
	#使用管理员账号登录系统
	...
	#过滤系统管理员和普通用户登入操作的日志
	@driver.userCenter_filterOperateLog_withUserName("系统管理员","普通用户")
	#查看操作日志信息列表中的日志是否正确
