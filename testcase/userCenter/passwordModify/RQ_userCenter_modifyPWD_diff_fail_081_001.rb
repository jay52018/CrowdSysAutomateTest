#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_userCenter_modifyPWD_diff_fail_081_001
# 用例标题: 管理员输入新密码与确认新密码不一致
# 预置条件: 
#	1.管理员用户已进入密码修改界面
# 测试步骤:
#	1.输入原密码：123456
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_userCenter_modifyPWD_diff_fail_081_001
	#使用管理员账户登录
	...
	#输入新密码：admin123
	@driver.userCenter_modifyPWD_newPWDField.set("admin123")
	#确认密码：admin12
	@driver.userCenter_modifyPWD_newPWD_confirmField.set("admin12")
	#点击“确认修改”按钮
	@driver.userCenter_modifyPWD_submmitBtn.click
	#弹出提示：请输入相同的密码
	assert_equal($modifyPWD_diffPWD_errCode,@driver.userCenter_navig_modifyPWD_errCode.when_present($waitTime).text,"新密码与确认密码不一致修改密码，提示信息异常")
	#注销系统，确认:0;取消：1
	@driver.logout()
  end
