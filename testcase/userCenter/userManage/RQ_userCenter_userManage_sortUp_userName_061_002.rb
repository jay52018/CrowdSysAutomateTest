#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_userCenter_userManage_sortUp_userId_061_002
# 用例标题: 按照用户姓名升序排列
# 预置条件: 
#	1.管理员已进入用户管理界面
# 测试步骤:
#	1.在用户列表中点击“用户姓名”
# 预期结果:
#	1.用户姓名旁向上的三角符高亮显示，用户列表按照用户姓名首字符的升序排列
# 脚本作者: kangting
# 写作日期: 20161017
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_userCenter_userManage_sortUp_userId_061_002
	#使用管理员账号登录系统
	...
	#在用户列表中点击“用户姓名”
	@driver.userCenter_userManage_userList_userName.when_present($waitTime).click
