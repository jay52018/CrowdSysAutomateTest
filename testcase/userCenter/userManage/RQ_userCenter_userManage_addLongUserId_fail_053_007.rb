#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_userCenter_userManage_addLongUserId_fail_053_007
# 用例标题: 添加长度超过20个字符的用户名
# 预置条件: 
#	1.管理员已进入用户管理界面
# 测试步骤:
#	1.点击“+添加新用户”
#	2.在“用户名”输入框输入：012345678901234567890
#	3.在“用户姓名”输入框输入：新用户
#	4.点击“确定添加”按钮
# 预期结果:
#	1.弹出“添加用户”窗口
#	4.添加失败，提示“用户名长度应在1-20个字符之间”
# 脚本作者: kangting
# 写作日期: 20161012
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_userCenter_userManage_addLongUserId_fail_053_007
	#使用管理员账号登录系统
	...
	#在“用户名”输入框输入：012345678901234567890
	@driver.userCenter_userManage_addUserIdField.set("012345678901234567890")
	#在“用户姓名”输入框输入：新用户
	@driver.userCenter_userManage_addUserNameField.set($newUserName)
	#点击“确定添加”按钮
	@driver.userCenter_userManage_submitAddUser_btn.click
	#提示“用户名长度应在1-20个字符之间”
	assert_equal($userManage_addUser_longUserId_errCode,@driver.userCenter_userManage_addUser_errCode.when_present($waitTime).text,"添加超长用户名的用户，提示信息异常")
	#关闭“添加用户”窗口
