#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_gatherAreaDrawing_triggerValue_fail_224_001
# 用例标题: 设置触发人群聚集事件阈值大于10000
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已添加名称为“基础视频”的摄像机
#	3.已进入到“基础视频”的详细配置界面
# 测试步骤:
#	1.在触发人群聚集事件阈值输入框输入：10001
#	2.正确配置其他必填项
#	3.点击“保存”
# 预期结果:
#	3.添加任务失败，提示：“触发人群聚集事件阈值不能大于10000！”
# 脚本作者: kangting
# 写作日期: 20161209
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_gatherAreaDrawing_triggerValue_fail_224_001
	#使用管理员账号登录
	...
	#输入触发聚集事件阈值：10001
	@driver.taskConfig_gatherAreaDraw_triggerThreshold_textField.set('10001')
	#点击“保存”按钮
	@driver.taskConfig_cameraConf_saveBtn.when_present($waitTime).click
	#弹出错误提示：触发人群聚集事件阈值不能大于10000！
	assert_equal($taskConfig_configureTask_gather_errTriggerThreshold_errCode,@driver.taskConfig_cameraConf_message.when_present($waitTime).text,'设置触发聚集事件阈值为10001，提示信息异常')
	#点击“取消”按钮
