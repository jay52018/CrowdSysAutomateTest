#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_safetyLevel_verySafe_206_001
# 用例标题: 安全级别为很安全的最大值大于100
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已添加名称为“基础视频”的摄像机
#	3.已进入到“基础视频”的详细配置界面
# 测试步骤:
#	1.在安全级别为很安全的最大值输入框输入：“101”
#	2.正确配置其他必填项
#	3.点击“保存”按钮
# 预期结果:
#	3.保存失败，弹出提示：“很安全最大值必须为100！”
# 脚本作者: kangting
# 写作日期: 20161206
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_safetyLevel_verySafe_206_001
	#使用管理员账号登录
	...
	#点击安全级别为很安全的最大值100
	@driver.taskConfig_safetySetting_data(100).click
	#在安全级别为很安全的最大值输入框输入：“101”
	3.times { @driver.simlate_sendkeys(:backspace) }
	...
	#弹出错误提示：很安全最大值必须为100！
	assert_equal($taskConfig_safetySetting_verySafeMax_errCode,@driver.taskConfig_safetySetting_errCode.when_present($waitTime).text,'设置安全级别为很安全的最大值大于100，提示信息异常')
