#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_denseAreaDrawing_triggerValue_fail_218_002
# 用例标题: 设置触发人群过密事件阈值等于100
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已添加名称为“基础视频”的摄像机
#	3.已进入到“基础视频”的详细配置界面
# 测试步骤:
#	1.在触发人群过密事件阈值输入框输入：100
#	2.正确配置其他必填项
#	3.点击“保存”
# 预期结果:
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_denseAreaDrawing_triggerValue_fail_218_002
	#使用管理员账号登录
	...
	#输入触发过密阈值：100
	@driver.taskConfig_denseAreaDraw_triggerThreshold_textField.set('100')
	#点击“保存”按钮
