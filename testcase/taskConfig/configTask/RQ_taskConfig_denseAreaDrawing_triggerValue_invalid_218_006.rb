#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_denseAreaDrawing_triggerValue_invalid_218_006
# 用例标题: 设置触发人群过密事件阈值为非数字
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已添加名称为“基础视频”的摄像机
#	3.已进入到“基础视频”的详细配置界面
# 测试步骤:
#	1.在触发人群过密事件阈值输入框输入：a<*><??
# 预期结果:
#	1.输入“a<*><??”失败
# 脚本作者: kangting
# 写作日期: 20161209
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_denseAreaDrawing_triggerValue_invalid_218_006
	#使用管理员账号登录
	...
	#输入触发过密阈值：-1
	@driver.taskConfig_denseAreaDraw_triggerThreshold_textField.set('a<*><??')
	#判断输入“a<*><??”失败
	assert_equal('',@driver.taskConfig_denseAreaDraw_triggerThreshold_textField.value,'错误！输入阈值为特殊字符成功')
	#点击“取消”按钮
