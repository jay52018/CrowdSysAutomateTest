#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_alreadyConfigured_enterConfigInterface_199_001
# 用例标题: 点击配置已配置好的任务
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已配置名称为“基础视频”的视频任务
# 测试步骤:
#	1.在任务列表中点击“基础视频”名称（点击配置）
# 预期结果:
#	1.跳转到“基础视频”的详细任务配置界面；所有配置信息与上一次配置的信息一致
# 脚本作者: kangting
# 写作日期: 20161205
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_alreadyConfigured_enterConfigInterface_199_001
	#使用管理员账号登录
	...
	#回到任务配置页面
	assert(@driver.assert_enterTaskConfig_element.when_present($waitTime).present?,"取消失败，未跳转到任务配置页面")
