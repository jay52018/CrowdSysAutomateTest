#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_eventAlarmSet_stranding_onlyOneStrategy_202_002
# 用例标题: 事件报警设置过滞留事件仅可选取一个策略
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已添加名称为“基础视频”的摄像机
#	3.已进入到“基础视频”的详细配置界面
...
# 预期结果:
#	1.滞留一行的“闪黄光”高亮显示
#	2.滞留一行的“闪橙光”高亮显示，上次设置的“闪黄光”由高亮变为非高亮
# 脚本作者: kangting
# 写作日期: 20161206
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_eventAlarmSet_stranding_onlyOneStrategy_202_002
	#使用管理员账号登录
	...
	#对滞留事件再配置“闪橙光”策略
	@driver.taskConfig_eventAlarmSet_btn(3,2).when_present($waitTime).click
	#滞留一行中的“闪黄光”非高亮显示
	assert_equal("",@driver.taskConfig_eventAlarmSet_btn(3,3).attribute_value(:class),"错误！滞留一行中的闪黄光仍然高亮显示")
	#滞留一行中的“闪橙光”高亮显示
	assert_equal("selected",@driver.taskConfig_eventAlarmSet_btn(3,2).attribute_value(:class),"错误！滞留一行中的闪橙光未高亮显示")
