#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_safetyLevel_safe_207_001
# 用例标题: 安全级别为安全的最小值大于最大值
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已添加名称为“基础视频”的摄像机
#	3.已进入到“基础视频”的详细配置界面
# 测试步骤:
#	1.在安全级别为安全的最小值输入框输入：81
#	2.正确配置其他必填项
#	3.点击“保存”按钮
# 预期结果:
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_safetyLevel_safe_207_001
	#使用管理员账号登录
	...
	assert_equal($taskConfig_safetySetting_safeMin_errCode,@driver.taskConfig_safetySetting_errCode.when_present($waitTime).text,'设置安全级别为安全的最小值大于最大值，提示信息异常')
