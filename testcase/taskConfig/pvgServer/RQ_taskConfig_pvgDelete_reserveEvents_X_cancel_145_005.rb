#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_pvgDelete_reserveEvents_X_cancel_145_005
# 用例标题: 在是否保留事件的窗口点击“X”取消删除pvg视频服务器
# 预置条件: 
#	1.管理员账号已进入任务配置页面
...
#	4.取消删除PVG视频服务器，关闭提示对话框，停留在编辑对话框
# 脚本作者: kangting
# 写作日期: 20161125
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_pvgDelete_reserveEvents_X_cancel_145_005
	#使用管理员账号登录
	...
	#点击“X”关闭窗口
	@driver.taskConfig_editTaskServer_confirmDialog_X.when_present($waitTime).click
	#检查窗口关闭，回到编辑窗口
	assert(@driver.taskConfig_editTaskServer_dialog_title.when_present($waitTime).present?,'窗口关闭后，未回到视频服务器编辑窗口')
	#关闭窗口
