#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_modifyPVG_PVGName_succ_146_001
# 用例标题: 修改pvg视频服务器名称
# 预置条件: 
#	1.管理员账号已进入任务配置页面
...
#	3.点击“保存”按钮
# 预期结果:
#	1.弹出pvg编辑窗口，名称默认显示为“172.17.2.32”
#	3.修改成功，弹出提示“修改成功！”；左边树列表中pvg名称显示为“2.32”
# 脚本作者: kangting
# 写作日期: 20161128
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_modifyPVG_PVGName_succ_146_001
	#使用管理员账号登录
	...
	#检查左边树列表中不存在名称为“2.32”的pvg，即认为pvg视频服务器删除成功
	assert_equal('false',@driver.taskConfig_treeList_videoName('2.32').present?.to_s,"还原失败，树列表中仍存在pvg视频服务器")
