#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_addPVG_nullPVGName_fail_132_001
# 用例标题: 添加名称为空的pvg视频服务器
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已弹出“添加PVG”窗口
# 测试步骤:
#	1.输入IP地址:172.17.2.32
#	2.输入端口：2100
#	3.输入用户名：admin
#	4.输入密码：admin
#	5.点击“确定”按钮
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_addPVG_nullPVGName_fail_132_001
	#使用管理员账号登录
	...
	#输入：IP、端口号、用户名、密码，点击“确定”
	@driver.taskConfig_addPVG('',$pvgIP,$pvgPort,$pvgAccount,$pvgPWD)
	#点击"确定"按钮
