#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_addPVG_errIP_fail_133_003
# 用例标题: 添加IP地址不正确的pvg视频服务器
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已弹出“添加PVG”窗口
# 测试步骤:
#	1.输入名称：172.17.2.32
#	2.输入IP地址：172.17.2.115
#	3.输入端口：2100
#	4.输入用户名：admin
#	5.输入密码：admin
#	6.点击“确定”按钮
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_addPVG_errIP_fail_133_003
	#使用管理员账号登录
	...
	@driver.taskConfig_addPVG($pvgName,'172.17.2.115',$pvgPort,$pvgAccount,$pvgPWD)
	#点击“确定”按钮
	@driver.taskConfig_addTaskServer_addPvg_submitBtn.click
	#检查弹出提示：“IP地址或端口错误！”
	assert_equal($taskConfig_addPvgServer_errIP_or_errPort_errCode,@driver.taskConfig_addTaskServer_message.when_present($waitTime).text,'添加错误IP地址的pvg，提示信息异常')
	#关闭添加窗口
