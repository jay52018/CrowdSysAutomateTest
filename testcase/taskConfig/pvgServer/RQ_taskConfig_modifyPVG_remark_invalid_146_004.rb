#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_modifyPVG_remark_invalid_146_004
# 用例标题: 修改pvg视频服务器备注包含特殊字符
# 预置条件: 
#	1.管理员账号已进入任务配置页面
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_modifyPVG_remark_invalid_146_004
	#使用管理员账号登录
	...
	#将备注修改为：“?(ty*”
	@driver.taskConfig_taskServer_remark_textArea.set('?(ty*')
	#点击“保存”按钮
	...
	#查看备注信息，判断是否为：?(ty*
	@driver.taskConfig_treeList_videoName($pvgName).click
	assert_equal('?(ty*',@driver.taskConfig_taskServer_remark_textArea.when_present($waitTime).value,'错误，与修改的备注不一致')
	#关闭窗口
