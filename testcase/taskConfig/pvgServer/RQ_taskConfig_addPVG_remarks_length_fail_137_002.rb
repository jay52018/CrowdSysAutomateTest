#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_addPVG_remarks_length_fail_137_002
...
#	4.输入用户名：admin
#	5.输入密码：admin
#	6.添加备注：11组“0123456789”
#	7.点击“确定”按钮
# 预期结果:
#	6.添加备注失败，只能输入10组“0123456789”
#	7.pvg添加成功，备注只保留10组“0123456789”
# 脚本作者: kangting
# 写作日期: 20161124
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_addPVG_remarks_length_fail_137_002
	#使用管理员账号登录
