#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_addPVG_errPort_fail_134_003
# 用例标题: 添加端口号不正确的pvg视频服务器
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已弹出“添加PVG”窗口
# 测试步骤:
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_addPVG_errPort_fail_134_003
	#使用管理员账号登录
	...
	@driver.taskConfig_addPVG($pvgName,$pvgIP,'2101',$pvgAccount,$pvgPWD)
	#点击“确定”按钮
	@driver.taskConfig_addTaskServer_addPvg_submitBtn.click
	#检查弹出提示：“IP地址或端口错误！”
	assert_equal($taskConfig_addPvgServer_errIP_or_errPort_errCode,@driver.taskConfig_addTaskServer_message.when_present($waitTime).text,'添加错误端口号的pvg，提示信息异常')
	#关闭添加窗口
