#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_deletePVG_X_cancel_145_004
# 用例标题: 点击“取消”取消删除pvg视频服务器
# 预置条件: 
#	1.管理员账号已进入任务配置页面
...
#	3.取消删除PVG视频服务器，关闭提示对话框，停留在编辑对话框
# 脚本作者: kangting
# 写作日期: 20161125
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_deletePVG_X_cancel_145_004
	#使用管理员账号登录
	...
	#取消成功，回到编辑窗口
	assert(@driver.taskConfig_editTaskServer_deleteBtn.when_present($waitTime).present?,"取消后，未回到编辑窗口")
	#关闭窗口
