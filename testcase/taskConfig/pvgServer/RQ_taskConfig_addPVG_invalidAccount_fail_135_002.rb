#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_addPVG_invalidAccount_fail_135_002
# 用例标题: 添加用户名包含非法字符的pvg视频服务器
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已弹出“添加PVG”窗口
# 测试步骤:
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_addPVG_invalidAccount_fail_135_002
	#使用管理员账号登录
	...
	@driver.taskConfig_addPVG($pvgName,$pvgIP,$pvgPort,'@*a',$pvgPWD)
	#点击“确定”按钮
