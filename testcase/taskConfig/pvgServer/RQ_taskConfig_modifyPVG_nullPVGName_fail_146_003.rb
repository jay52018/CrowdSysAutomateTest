#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_modifyPVG_nullPVGName_fail_146_003
# 用例标题: 修改pvg视频服务器名称为空
# 预置条件: 
#	1.管理员账号已进入任务配置页面
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_modifyPVG_nullPVGName_fail_146_003
	#使用管理员账号登录
	...
	#清空名称
	@driver.taskConfig_editTaskServer_serverName_textField.clear
	#点击“保存”按钮
	@driver.taskConfig_editTaskServer_saveBtn.click
	#检查弹出提示：“名称不能为空！”
	assert_equal($taskConfig_editPvgServer_nullName_errCode,@driver.taskConfig_editTaskServer_errCode.when_present($waitTime).text,'将pvg视频服务名称修改为空，提示信息异常')
	#关闭添加窗口
