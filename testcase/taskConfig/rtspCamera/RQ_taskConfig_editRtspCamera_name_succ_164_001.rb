#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_editRtspCamera_name_succ_164_001
# 用例标题: 修改rtsp摄像机的名称
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已添加名称为“RTSP”的rtsp摄像机
# 测试步骤:
#	1.在左边树列表中点击rtsp摄像机任务“RTSP”的编辑图标
#	2.将名称修改为“rtspcamera”
#	3.点击“保存”按钮
# 预期结果:
#	1.弹出“摄像机配置”窗口；名称默认显示为“RTSP”
#	3.修改成功，弹出提示：“修改成功！”；摄像机名称在列表中显示为：“rtspcamera”
# 脚本作者: kangting
# 写作日期: 20161207
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_editRtspCamera_name_succ_164_001
	#使用管理员账号登录
	...
	#高亮后，点击编辑小图标
	@driver.taskConfig_editTask_btn($rtsp_row).when_present($waitTime).click
	
	#将名称修改为“rtspcamera”
	20.times { @driver.simlate_sendkeys(:backspace) }
	@driver.simlate_sendkeys("rtspcamera")
	#确认修改
	@driver.curr_time.click
	#检查左边树列表中的rtsp摄像机名称修改为“rtspcamera”
	assert(@driver.taskConfig_treeList_videoName('rtspcamera').when_present($waitTime).present?,'错误！左边数列表中没有新增的rtsp视频任务')
