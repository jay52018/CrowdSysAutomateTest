#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_editRtspCamera_nullName_fail_165_001
# 用例标题: 修改rtsp摄像机名称为空
# 预置条件: 
#	1.管理员账号已进入任务配置页面
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_editRtspCamera_nullName_fail_165_001
	#使用管理员账号登录
	...
	#弹出提示：摄像机的名称不能为空
	assert_equal($taskConfig_editRtspCamera_nullName_errCode,@driver.taskConfig_editCamera_errCode.when_present($waitTime).text,'将摄像机名称修改为空，提示信息异常')
