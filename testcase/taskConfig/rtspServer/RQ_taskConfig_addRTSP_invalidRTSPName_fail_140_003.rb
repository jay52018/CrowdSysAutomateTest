#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_addRTSP_invalidRTSPName_fail_140_003
# 用例标题: 添加名称包含非法字符的rtsp视频服务器
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已弹出“添加RTSP”窗口
# 测试步骤:
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_addRTSP_invalidRTSPName_fail_140_003
	#使用管理员账号登录
	...
	#输入rtspURL
	@driver.taskConfig_addRtsp('!*rt@sp-',$rtspURL)
	#点击“确定”
	@driver.taskConfig_addTaskServer_addRtsp_commitBtn.click
	#检查弹出提示：“名称格式不正确，请修改！”
	assert_equal($taskConfig_addRtsp_invalidName_errCode,@driver.taskConfig_editTaskServer_errCode.when_present($waitTime).text,'添加名称包含特殊字符的rtsp视频，提示信息异常')
	#关闭添加窗口
