#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_addRTSP_cancel_142_001
# 用例标题: 点击“取消”按钮取消添加RTSP视频服务器
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已弹出“添加RTSP”窗口
# 测试步骤:
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_addRTSP_cancel_142_001
	#使用管理员账号登录
	...
	#点击“取消”
	@driver.taskConfig_addTaskServer_addRtsp_cancelBtn.click
