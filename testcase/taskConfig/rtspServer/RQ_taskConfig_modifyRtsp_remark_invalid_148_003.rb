#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_modifyRtsp_remark_invalid_148_003
# 用例标题: 修改rtsp视频服务器备注包含特殊字符
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已弹出“rtsp视频”编辑窗口
# 测试步骤:
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_modifyRtsp_remark_invalid_148_003
	#使用管理员账号登录
	...
	#将备注修改为“-*dde?”
	@driver.taskConfig_taskServer_remark_textArea.when_present($waitTime).set('-*dde?')
	#点击“保存”按钮
