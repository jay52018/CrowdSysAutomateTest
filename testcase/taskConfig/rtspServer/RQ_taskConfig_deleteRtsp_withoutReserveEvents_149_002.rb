#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_deleteRtsp_withoutReserveEvents_149_002
# 用例标题: 删除rtsp视频服务器不保留事件
# 预置条件: 
#	1.管理员账号已进入任务配置页面
...
#	3.弹出提示：视频服务器删除成功，在“事件查询”中不能查阅到相关的状态和事件信息
# 脚本作者: kangting
# 写作日期: 20161129
#=========================================================
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_deleteRtsp_withoutReserveEvents_149_002
	#使用管理员账号登录
