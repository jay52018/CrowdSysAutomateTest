#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_deleteRtsp_reserveEvents_X_cancel_149_005
# 用例标题: 在是否保留事件的窗口点击“X”取消删除rtsp视频服务器
# 预置条件: 
#	1.管理员账号已进入任务配置页面
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_deleteRtsp_reserveEvents_X_cancel_149_005
	#使用管理员账号登录
