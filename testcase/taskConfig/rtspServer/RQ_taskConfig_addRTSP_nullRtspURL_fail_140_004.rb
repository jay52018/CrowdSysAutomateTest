#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_addRTSP_nullRtspURL_fail_140_004
# 用例标题: 添加RTSP路径为空的rtsp视频服务器
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已弹出“添加RTSP”窗口
# 测试步骤:
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_addRTSP_nullRtspURL_fail_140_004
	#使用管理员账号登录
	...
	#输入必填项，添加rtsp视频服务器
	@driver.taskConfig_addRtsp($rtspTaskName,'')
	#点击“确定”
	@driver.taskConfig_addTaskServer_addRtsp_commitBtn.when_present($waitTime).click
	#检查弹出提示：“rtsp路径不正确”
	assert_equal($taskConfig_addRtsp_URL_errCode,@driver.taskConfig_addTaskServer_errCode.when_present($waitTime).text,'添加url为空的rtsp视频，提示信息异常')
	#关闭添加窗口
