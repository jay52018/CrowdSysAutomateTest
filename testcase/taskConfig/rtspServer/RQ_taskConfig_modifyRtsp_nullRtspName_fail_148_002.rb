#========================================================
#+++++++++++++++++  测试用例信息   ++++++++++++++++
# 用例  ID: RQ_taskConfig_modifyRtsp_nullRtspName_fail_148_002
# 用例标题: 修改rtsp视频服务器名为空
# 预置条件: 
#	1.管理员账号已进入任务配置页面
#	2.已弹出“rtsp视频”编辑窗口
...
class CrowdSystemTest < MiniTest::Unit::TestCase
  ...
  def test_RQ_taskConfig_modifyRtsp_nullRtspName_fail_148_002
	#使用管理员账号登录
	...
	#清空名称
	@driver.taskConfig_editTaskServer_serverName_textField.when_present($waitTime).clear
	#点击“保存”按钮
	@driver.taskConfig_editTaskServer_saveBtn.click
	#弹出提示：视频名称不能为空！
	assert_equal($taskConfig_editRtspServer_nullName_errCode,@driver.taskConfig_editTaskServer_errCode.when_present($waitTime).text,'修改rtsp视频服务器名称包含非法字符，提示信息异常')
	#关闭编辑窗口
